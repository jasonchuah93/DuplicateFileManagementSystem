...
void test_hashCRC_should_be_equal_for_two_file_with_same_content_but_different_name(void){
 ...
 UnityAssertEqualNumber((_U_SINT)((checksum1)), (_U_SINT)((checksum2)), (((void *)0)), (_U_UINT)(13), UNITY_DISPLAY_STYLE_INT);
...
void test_hashCRC_should_be_equal_for_two_file_with_same_content_but_different_name_in_excel_format(void){
 ...
 UnityAssertEqualNumber((_U_SINT)((checksum1)), (_U_SINT)((checksum2)), (((void *)0)), (_U_UINT)(41), UNITY_DISPLAY_STYLE_INT);
